...
(function () {
  ...
  const CSS = `
    ...
    * { box-sizing: border-box; }
    ...
    .section-head h2 { margin: 0 0 12px; font-size: 12.5px; font-weight: 600; }
    .section-head em { font-style: normal; font-weight: normal; color: var(--ink-faint); font-size: 11px; margin-left: 8px; }
